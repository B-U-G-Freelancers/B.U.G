...
// Carousel of tilted cards with scroll support
function ProjectCarousel({
  ...
  return (
    ...
    >
      ...
      <div
        ref={scrollRef}
        className="flex items-center h-full overflow-x-auto scrollbar-hide px-[calc(50vw-175px)] snap-x snap-mandatory"
        style={{
          gap: `${gap}px`,
