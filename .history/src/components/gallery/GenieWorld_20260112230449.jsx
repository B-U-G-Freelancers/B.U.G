    ...
    >
      ...
      >
        {projects.map((project, index) => {
          ...
          // Calculate rotation for bend effect
          const distanceFromCenter = index - currentIndex;
          const rotateY = distanceFromCenter * 25; // Rotate cards based on position
          const translateZ = Math.abs(distanceFromCenter) * -80; // Push back cards further from center
