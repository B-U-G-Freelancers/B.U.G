      ...
      >
        ...
        >
          ...
          >
            ...
            />
            <div
              className="flex flex-col ml-3 transition-colors duration-300"
              style={{ color: open ? "#000000" : "#E6E6E6" }}
            >
        ...
        >
          <div className="sm-panel-inner flex-1 flex flex-col gap-5">
            ...
            {displaySocials && socialItems && socialItems.length > 0 && (
              ...
              >
                <h3 className="sm-socials-title m-0 text-base font-medium [color:var(--sm-accent,#3A7CFF)] text-black">
                  Socials
                </h3>
                <ul
