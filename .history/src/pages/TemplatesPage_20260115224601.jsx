...
function TemplatePreviewModal({ template, onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-[100] bg-black">
      ...
      {/* Iframe container */}
      <div className="h-full w-full flex items-center justify-center pt-20 pb-6 px-6">
        <div
          className="h-full bg-white rounded-lg overflow-hidden shadow-2xl transition-all duration-500"
          style={{
      ...
      {contentVisible && (
        ...
        >
          ...
          <div className="text-center mb-16">
            ...
            >
              Premium templates crafted by B.U.G. Your wish is our command —
              choose your starting point and we'll bring it to life.
            </p>
          </div>
