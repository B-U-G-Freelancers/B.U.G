    ...
    >
      ...
      <AnimatePresence>
        {currentState === STATES.GALLERY && (
          <>
            {/* Gallery content - revealed underneath curtain */}
            <motion.div
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
            ...
            {/* Theatre curtain reveal - rises from bottom to top with wave effect */}
            <motion.div
              initial={{ y: 0 }}
              animate={{ y: "-100%" }}
              transition={{
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 h-[80px] overflow-hidden">
                ...
                >
                  <path
                    fill="#000"
                    d="M0,0 C360,80 720,0 1080,40 C1260,60 1350,20 1440,0 L1440,0 L0,0 Z"
                  />
                  <path
                    fill="#000"
                    fillOpacity="0.8"
                    d="M0,20 C240,60 480,0 720,40 C960,80 1200,20 1440,40 L1440,0 L0,0 Z"
                  />
                </svg>
              </div>
