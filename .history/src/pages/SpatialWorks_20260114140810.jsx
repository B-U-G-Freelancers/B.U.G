// src/pages/SpatialWorks.jsx
// Immersive spatial projects page - separate from GenieWorld
...
const PROJECTS = [
  {
    ...
    challenge:
      "The existing transaction engine was built on a monolithic architecture that couldn't handle the increasing volume of trades during peak hours.",
    solution:
      "We redesigned the system using a microservices architecture with Redis-based caching and WebSocket connections for real-time data streaming.",
  },
  {
    id: "2",
    year: "2023",
    ...
    timeline: "6 months",
    tech: "React Native, AWS, HIPAA Infrastructure",
    challenge:
      "Healthcare providers needed a reliable telehealth platform that could handle surge capacity while maintaining strict HIPAA compliance.",
    solution:
      "We implemented auto-scaling infrastructure with end-to-end encryption, achieving 99.99% uptime.",
  },
  {
    id: "3",
    year: "2024",
    ...
    challenge:
      "Customer support teams were overwhelmed with repetitive queries, leading to long wait times.",
    solution:
      "We fine-tuned LLM models on company-specific data and built an intelligent routing system with 94% accuracy.",
  },
  {
    id: "4",
    year: "2022",
    ...
    challenge:
      "Traditional automotive dashboards had sluggish touch response and consumed significant battery power.",
    solution:
      "We developed a lightweight middleware layer with predictive touch algorithms, achieving 60fps with 40% less power.",
  },
  {
    id: "5",
    year: "2024",
...
export default function SpatialWorks() {
  return <SpatialGallery projects={PROJECTS} />;
}
