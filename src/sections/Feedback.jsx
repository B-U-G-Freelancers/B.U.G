...
const feedbacks = [
  {
    text: "The team at B.U.G didn't just build a website; they architected a digital ecosystem. The precision and aesthetic is unmatched.",
    name: "Alexander K.",
    role: "CTO, Vertex Core",
  },
  {
    text: "Working with B.U.G felt like integrating with a futuristic command system. Every detail was intentional and powerful.",
    name: "Sophia M.",
    role: "Product Lead, Nova Systems",
  },
  {
    text: "Their cyberpunk design language and engineering depth gave our platform a presence that truly stands out.",
    name: "Ethan R.",
    role: "Founder, Orbit Labs",
  },
  {
    text: "B.U.G transformed our vision into a living digital experience. The system feels fast, intelligent, and visually elite.",
    name: "Liam O.",
    role: "Engineering Manager, Flux Dynamics",
  },
  {
    text: "From UI motion to backend logic, everything feels synchronized. It’s not just development — it’s digital architecture.",
    name: "Isabella T.",
    role: "Head of Design, Neon Collective",
  },
  {
    text: "We wanted something bold, scalable, and futuristic. What we received was a platform that feels years ahead.",
    name: "Noah P.",
    role: "CEO, Hyperlane Tech",
  },
  {
    text: "B.U.G delivered a system that looks cinematic but performs flawlessly. That balance is extremely rare.",
    name: "Aarav S.",
    role: "Tech Strategist, Quantum Edge",
  },
  {
    text: "The attention to interaction, motion, and performance is unreal. It feels like operating inside a digital universe.",
    name: "Maya R.",
