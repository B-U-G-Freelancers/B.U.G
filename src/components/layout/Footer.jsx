          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            <form onSubmit={handleNewsletterSubmit} className="relative">
              <input
                ...
                className="w-full px-4 py-3 pr-12 text-sm bg-white/5 border border-white/10 rounded-lg text-text-primary placeholder:text-text-muted focus:outline-none focus:border-accent/50 focus:bg-white/[0.07] transition-all duration-300"
              />
              <button
                type="submit"
                className="absolute right-2 top-1/2 -translate-y-1/2 p-2 text-text-muted hover:text-accent transition-colors duration-300"
