    ...
    >
      ...
      <div
        className={`h-full flex ${
          template.type === "wide" ||
          (template.type === "large" && window.innerWidth >= 768)
      ...
      >
        ...
        <div
          className={`relative overflow-hidden ${
            template.type === "large"
              ? "md:w-3/5 h-[300px] md:h-auto"
              : template.type === "wide"
              ? "md:w-1/2 h-[200px] md:h-auto"
              : template.type === "tall"
              ? "h-[60%] w-full"
              : "h-[200px] w-full"
          }`}
        ...
        {/* Content Section */}
        <div
          className={`p-6 flex flex-col justify-between relative z-10 ${
            template.type === "large"
              ? "md:w-2/5 border-t md:border-t-0 md:border-l border-white/[0.06]"
              : template.type === "wide"
              ? "md:w-1/2 border-t md:border-t-0 md:border-l border-white/[0.06]"
              : template.type === "tall"
