  ...
  return (
    <>
      ...
      >
        ...
        {/* Title overlay */}
        <div className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-10 pointer-events-none text-center">
          <h1 className="font-display text-6xl sm:text-8xl lg:text-9xl font-black tracking-tighter text-white/10">
            WORKS
          </h1>
        </div>
